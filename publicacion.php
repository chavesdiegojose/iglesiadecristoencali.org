...
<div class="card text-white imagen-section" style="margin-bottom:-250px;">
  ...
  <div class="card-img-overlay">
    <h1 class="card-title title-card-radio Oswald-Regular text-white" style="margin-top: 50px;font-size: 4em;margin-left: 20px; text-align: center;"><?php echo $sql["titulo"]; ?></h1>
  </div>
</div>
...
<div class="card" style="max-width: 100%; margin-left: 1.5em; margin-right: 1.5em;">
  <div class="row g-0" style="padding: 1.5em;">
    ...
    <div class="col-md-6">
      ...
      <div class="card-body">
        <h5 class="card-title Oswald-Regular" style="font-size: 1.1em;"><?php echo $sql_items["titulo"]; ?></h5>
        <p class="card-text Oswald-Light" style="font-size: 1.1em;"><?php echo $viewinfo; ?></p>
      </div>
                        ...
                        ?>
                            <div class="list-group-item list-group-item-action">
                                <div class="Oswald-Regular justify-content-between text-center">
