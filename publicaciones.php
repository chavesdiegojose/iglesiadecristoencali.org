...
<div class="card text-white imagen-section" style="margin-bottom:-250px;">
  <img src="img/publicaciones3.jpg" class="card-img" alt="...">
  <div class="card-img-overlay">
    <h1 class="card-title title-card-radio Oswald-Regular text-white" style="margin-top: 50px;font-size: 4em;margin-left: 20px; text-align: center;">Publicaciones</h1>
  </div>
</div>
...
<div class="posts-ultimos row row-cols-1 row-cols-md-5 g-6" style="padding-left: 1em; padding-right: 1em;">
            ...
            ?>
  <div class="col">
    <div class="card  style-card" style="border: 1px solid #0097ff;">
      ...
      <div class="card-body">
        ...
        <a href="publicacion.php?id_post=<?php echo $sql["id_post"]; ?>" class="card-link Oswald-Bold text-primary">VER</a>
      </div>
    </div>
  </div>
              ...
              <?php         
                      ...
                      echo "<div id='sin-articulos' class='col alert alert-primary Oswald-Light' style='width: 60%; margin-right: auto;margin-left: auto; font-size: 1.1em;' align='center'><strong>No hay artículos disponibles por el momento.</strong></div>";
                  }
              ?>
